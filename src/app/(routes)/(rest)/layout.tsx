...
export default async function Layout({
  ...
  return (
    <>
      ...
      <div
        className="text-shadow-primary-md pointer-events-none  fixed bottom-1 left-1/2 -translate-x-1/4 select-none text-[10px] uppercase leading-none text-primary/50"
        aria-hidden="true"
      >
