  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute left-0 top-[35dvh] h-[5px] w-full bg-primary/60 after:absolute after:left-3 after:top-0 after:flex after:h-[14px] after:w-[14px] after:items-center after:justify-center after:bg-primary/60 after:text-sm after:font-semibold after:leading-none after:text-secondary after:content-['1']"></div>
      </div>
      <div
        aria-hidden="true"
        className="pointer-events-none fixed left-0 top-[70dvh] origin-top-left -rotate-90 select-none whitespace-nowrap text-[9px] uppercase text-primary/40"
      >
      ...
      <div
        className="pointer-events-none fixed  bottom-1 left-1/2 -translate-x-1/4 select-none text-[10px] uppercase leading-none text-primary/50 text-shadow-primary-md"
        aria-hidden="true"
      >
      ...
      <main className="flex grow flex-col pb-7">{children}</main>
    </>
  );
}
