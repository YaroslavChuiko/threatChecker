  ...
  return (
    <section className="mt-32 flex items-center justify-center">
      <div className="max-w-2xl">
        <div className="bg-noise relative flex h-10 w-[calc(100%-1px)] select-none items-center justify-between bg-mainColor px-5 text-lg font-medium leading-none text-secondaryColor/90 before:absolute before:inset-x-4 before:bottom-0 before:z-10 before:block before:h-[1px] before:bg-secondaryColor/90 before:content-['']">
