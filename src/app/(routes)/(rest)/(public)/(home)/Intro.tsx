...
const Intro = () => {
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col items-start border border-mainColor bg-mainColor/5 px-5 py-6">
        ...
        <div className="ml-1">
          ...
          <p className="mt-6 text-xs text-mainColor/70">
            <span className="uppercase font-semibold">Attention:</span> ThreatChecker is a free website security
